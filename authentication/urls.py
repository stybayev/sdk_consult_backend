...
urlpatterns = [
    ...
    #
    # path('resend_phone_verify/',
    #      ResendVerificationPhoneView.as_view(),
    #      name='resend_phone_verify'),
    #
    # path('token/refresh/',
    ...
    #
    # path('phone_change_verify/',
    #      VerifyPhoneChangeView.as_view(),
    #      name='phone_change_verify'),
    #
